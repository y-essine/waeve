<template>
    <div class="flex">
        <Avatar src="https://cloudflare-ipfs.com/ipfs/Qmd3W5DuhgHirLHGVixi6V76LhCkZUz6pnFt5AJBiyvHye/avatar/1103.jpg"
            :size="12" class="mr-4 hidden 2xs:block" />
        <div class="flex-1">
            <textarea class="w-full px-4 py-3 text-tertiary-t focus:text-primary-t text-sm xs:text-base"
                placeholder="What's on your mind?" id="mytext" style="height: 48px; max-height: 250px;" value="">
            </textarea>
            <div v-if="true" class="flex justify-between pt-2">
                <label
