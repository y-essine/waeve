                    ...
                    <div>
                        <div class="block xs:flex">
                            <div class="flex items-center">
                                ...
                                <div v-if="post.author.verified" class="pl-2">
                                    <div class="tooltip flex items-center" data-tip="Verified">
                                        <Icon icon="verified" color="#53c8ff" :size="18" />
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center">
    ...
    'text-sm sm:text-base'
        ...
        <div class="middle-part my-">
            <div class="flex-1 flex-wrap">
                <div v-for="image in [post.images[0]]" :key="image"
...
" alt="Post attachment image" class="w-full" />
                </div>
            </div>
        </div>
